...
dataMix = {
	data(){
		return {
			tablePk : 'nobp',
			url_get : "/api/mahasiswa",
			defaultSort : [{field:"nm_mahasiswa",direction:"asc"}],
			columns : [
				{name: "__sequence", title:"No"},
				{name: "nm_mahasiswa", title:"Nama Mahasiswa", sortField : "nm_mahasiswa"},
				{name: "nobp", title:"NOBP", sortField : "nobp"},
