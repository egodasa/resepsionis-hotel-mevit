...
@section('title','Kelola Jenis Soal')
@section('content')
	<div id="app">
...
dataMix = {
	data(){
		return {
			tablePk : 'id_jsoal',
			url_get : "/api/jenis-soal",
			defaultSort : [{field:"nm_jsoal",direction:"asc"}],
			columns : [
				{name: "__sequence", title:"No"},
				{name: "id_soal", title:"ID", sortField : "id_soal",visible:false},
				{name: "nm_jsoal", title:"Nama Jenis Soal", sortField : "nm_jsoal"},
