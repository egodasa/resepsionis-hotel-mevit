...
@section('title','Kelola Nama Kelas')
@section('content')
	<div id="app">
...
dataMix = {
	data(){
		return {
			tablePk : 'id_kelas',
			url_get : "/api/kelas",
			defaultSort : [{field:"nm_kelas",direction:"asc"}],
			columns : [
				{name: "__sequence", title:"No"},
				{name: "id_kelas", title:"ID", sortField : "id_kelas",visible:false},
				{name: "nm_kelas", title:"Nama Kelas", sortField : "nm_kelas"},
